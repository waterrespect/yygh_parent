...
public class HospApiController {
    ...
    public Result getBookingSchedule(
            ...
            @PathVariable Integer limit,
            @ApiParam(name = "hoscode", value = "醫院code", required = true)
    ...
    @ApiOperation(value = "根據排班id獲取排版數據")
